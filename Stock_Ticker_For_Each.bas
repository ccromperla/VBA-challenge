...
For Each ws In Worksheets
 ...
 For i = 2 To Last_Row
  ...
  If ws.Cells(i + 1, 1).Value <> ws.Cells(i, 1).Value Then
   ...
   'Ticker Value id'd and added to the ticker spot
   ...
   'Format Yearly Change so the increase in value is colored green, a decrease in value is red, no change in value is yellow
